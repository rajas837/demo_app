...
class HistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create history" do
    assert_difference('History.count') do
      post histories_url, params: { history: { description: @history.description, transaction_history: @history.transaction_history } }
    end
  ...
  test "should update history" do
    patch history_url(@history), params: { history: { description: @history.description, transaction_history: @history.transaction_history } }
